...
echo "    Gemini       — set GEMINI_API_KEY (free key: aistudio.google.com/apikey)"
echo "                   Google-account login was retired June 18, 2026"
echo "    ChatGPT      — run: codex (opens your browser to sign in)"
echo ""
echo -e "  ${DIM}Free tiers work. You can add these later — megavibe works without them.${RESET}"
echo ""
